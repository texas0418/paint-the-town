...
import { activityOptions, VenueStyle } from '@/types/planner';
...
type ChipOption = { id: string; name: string; emoji: string };
type SetString = (v: string) => void;
type SetStringList = (v: string[]) => void;
type Toggle = (list: string[], setList: SetStringList, id: string) => void;

export type OnboardingStyles = ReturnType<typeof createStyles>;

export function WelcomeStep({ styles, colors }: { styles: OnboardingStyles; colors: ThemeColors }) {
  return (
        ...
        <View style={styles.welcomeFeatures}>
          ...
          <View style={styles.featureItem}>
            ...
            <Text style={styles.featureText}>
              &quot;Plan it for me&quot; — pick from 3 ready-made dates
            </Text>
          </View>
        </View>
      </View>
...
export function DislikesStep({
  ...
  foodLoves: string[];
  foodDislikes: string[];
  setFoodDislikes: SetStringList;
  activityLoves: string[];
  activityDislikes: string[];
  setActivityDislikes: SetStringList;
  toggle: Toggle;
}) {
  return (
    <View style={styles.stepContainer}>
...
export function LogisticsStep({
  ...
  setVenueStyle: (v: VenueStyle) => void;
  dateBudget: number;
  setDateBudget: (v: number) => void;
  homeCity: string;
  setHomeCity: SetString;
}) {
  return (
    <KeyboardAvoidingView
...
export function createStyles(colors: ThemeColors) {
  return { ...createBaseStyles(colors), ...createStepStyles(colors) };
}
